...
<head>
  ...
  <title>personal finance management system | Login</title>
...
<body class="">
    ...
    <nav class="navbar navbar-expand bg-navy navbar-light">
        <!-- Left navbar links -->
        <b><h3 ><a href="index.php" class="text-light"><b><i>personal finance management system.</i></b></a></h3></b>
...
<div class="container mt-5">
    ...
    <div class="col-md-6 float-left mt-5 " >
              <h1 class="text-danger text-center"><b> About <i class="text-white"> personal finance management system.</i> <hr class="bg-light"></b></h1>
              <div class="text-light bg-navy p-4" style="border-radius:5%;">
                <h4 class=" text-light " >Welcome to <b><i class="text-danger"> personal finance management system </i></b>.This is a place where you can easily :</h4>
                <ul type="none">
